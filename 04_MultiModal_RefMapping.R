...
fwrite(Celltype, 'MMRM_celltype.csv', row.names = TRUE)
fwrite(as.data.frame(refspca), 'MMRM_spca.csv', row.names = TRUE)
fwrite(as.data.frame(refumap), 'MMRM_umap.csv', row.names = TRUE)
