...
# Define marker genes
marker_genes = [
    'PPP1R14A', 'LILRA4', 'AXL',      # ASDC
    'MS4A1', 'CD79A', 'CD19',         # pan B cells
    'IGHD', 'IGHM',                   # B naive (includes IgD and IgM)
    'CD27',                           # B memory (CD19 already listed)
    'CD3D', 'CD4',                    # T cell, CD4      
    'GZMB', 'CXCR3', 'TBX21',         # CD4 CTL
    'CCR7',                           # CD4 Naive
    'MKI67', 'PCNA',                  # Proliferating
    'CCL5',                           # CD4 TEM (CD4, GZMK already listed)               
    'CD8A',                           # CD8 Naive (CCR7, SELL already listed)
    'CCL5',                           # CD8 TEM (CD8A, GZMK already listed)
    'ANXA1',                          # CD8 TCM (CD8A, CCR7 already listed)    
    'LYZ',                            # pan Mono
    'CD14',                           # CD14 Mono
    'FCGR3A', 'CX3CR1',               # CD16 Mono (CD16 is FCGR3A)                        
    'HBA1', 'HBB',                    # Eryth             
    'CD34', 'KIT',                    # HSPC  
    'IL7R', 'ZBTB16', 'ID2',          # ILC (KIT already listed)
    'TRAV1-2', 'SLC4A10',             # MAIT
    'NKG7', 'GNLY', 'FCGR3A',         # NK (list CD16 again here anyway)  
    'NCAM1',                          # CD56 NK
    'CD38','MZB1',                    # Plasmablast (CD27 already listed)
    'PPBP', 'ITGA2B',                 # Platelet
    'FOXP3', 'IL2RA', 'CTLA4',        # Treg        
    'CLEC9A', 'DNASE1L3', 'CADM1',    # cDC1
    'ITGAX', 'CD1C', 'FCER1A',        # cDC2
    'CD2',                            # dnT
    'TRDC', 'TRGV9',                  # gdT
    'IL3RA', 'TCF4'                   # pDC (IL3RA, LILRA4 already listed)
]

# Plot dotplot for marker genes
sc.pl.dotplot(adata, var_names=marker_genes, groupby='CellType', show=True, save='PBMC_dotplot_markers.pdf')
